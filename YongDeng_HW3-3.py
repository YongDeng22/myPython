...
#*****************************************************************************************
	...
	#Author: Yong Deng
	#Since:  4-28-2015
	#This program is a to improve the efficiency of previously build search engin in
	#YongDeng_HW2.py.
#*****************************************************************************************

#-------------------------------------------------------------------------------------------
#pre-processing data
word_dic = { }	#dictioanry container for all of the words (key) and sentence number(value)
finalList = []	#list container for all of the sentences
...
foundSet = set()	#initialize set container which holds hits
...
if foundSet:
	...
	for i in foundSet:
		for m, quote in enumerate(data_list):
			if m == i:
...
print("Execution time:", dt2.microsecond-dt1.microsecond)	#calcuate running time
...
# Yongs-MBP-5:~ yongdeng$ python3 /Users/yongdeng/Documents/CS/UNH\ assignments/CSCI\ 6651\ python/myPython/YongDeng_HW3-3.py 
# query:sheep and flower important
